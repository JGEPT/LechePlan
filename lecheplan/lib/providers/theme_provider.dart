...
final Color lightGreyColor = Color(0xFFF3F1EF);
//gradient colors
...
final BoxShadow defaultBoxShadow = BoxShadow(color: unselectedGreyColor.withAlpha(20), blurRadius: 5, spreadRadius: 1);